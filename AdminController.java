...
public class AdminController {
     ...
     * 后台错误视图
     */
    protected final static String ERROR_VIEW_ADMIN = "/admin/error/404.jsp";

    // protected final static String AMIND_LOGIN_URL =
    // "redirect:"+Config.get().getDomain()+"admin/login.htm";
